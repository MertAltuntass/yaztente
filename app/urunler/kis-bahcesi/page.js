...
export const metadata = {
  title: 'Kış Bahçesi Modelleri İstanbul Beykoz | Yaz Tente',
  description: 'İstanbul Beykoz\'da alüminyum ve cam kış bahçesi montajı. Dört mevsim kullanılabilir ısıcam sistemleri. Ücretsiz keşif: 0546 770 25 83.',
  keywords: 'kış bahçesi modelleri İstanbul, cam kış bahçesi Beykoz, alüminyum kış bahçesi, teras kapatma, veranda sistemi',
}
