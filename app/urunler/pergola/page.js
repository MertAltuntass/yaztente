...
const products = [
  ...
  {
    image: 'https://images.unsplash.com/photo-1696454596847-dda5f2dc0555?w=800&q=80',
  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="bg-dark pt-32 pb-16 relative overflow-hidden">
        <div className="absolute inset-0 opacity-30" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1527359443443-84a48aec73d2?w=1920&q=80)', backgroundSize: 'cover', backgroundPosition: 'center'}} />
