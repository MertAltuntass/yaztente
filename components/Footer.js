        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Profesyonel gölgelendirme sistemleri ile yaşam alanlarınıza konfor ve estetik katıyoruz.
              Kaliteli malzeme, usta işçilik ve güvenilir hizmet.
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-dark-light rounded-full flex items-center justify-center hover:bg-primary transition-colors text-white">
          ...
          {/* Ürünler */}
          <div>
            <h3 className="text-white font-semibold text-lg mb-5 border-b border-primary pb-2 inline-block">
              Ürünlerimiz
            </h3>
            <ul className="space-y-3">
              {[
                { href: '/urunler/tente', label: 'Tente Sistemleri' },
                { href: '/urunler/pergola', label: 'Pergola & Alüminyum' },
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: '/galeri', label: 'Proje Galerisi' },
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} YAZ Gölgelendirme Sistemleri. Tüm hakları saklıdır.
          </p>
          <div className="flex gap-6">
            <Link href="#" className="text-gray-500 hover:text-primary text-sm transition-colors">Gizlilik Politikası</Link>
            <Link href="#" className="text-gray-500 hover:text-primary text-sm transition-colors">Kullanım Koşulları</Link>
          </div>
        </div>
      </div>
    </footer>
